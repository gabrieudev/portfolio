...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const { firstname, lastname, email, phone, position, message } =
            formValues;
        if (
            !firstname ||
            !lastname ||
                    ...
                    <div className="xl:h-[54%] order-2 xl:order-none">
                        ...
                        >
                            ...
                            <p className="text-white/60">
                                Se você procura um profissional comprometido e
                                apaixonado por tecnologia, entre em contato!
                                Vamos juntos criar soluções inovadoras e
